...
include { ESTIMATE_TAIL as TAILFINDR_ESTIMATE_TAIL } from "${subworkflowsDir}/chem_modification/tailfindr" addParams(CONTAINER:"biocorecrg/moptail:1.3", LABEL: 'big_cpus_retry', EXTRAPARS: progPars["tailfindr--tailfindr"])
